...
if len(sys.argv) != 3:
    ...
    print "INTEGRATE.HKL are necessary to get MAXC information. It can be substituted by XDS_ASCII.HKL, however in such case one only gets information on equivalent intensities."
    print ""
    ...
    print "python CorrDataset.py <INTEGRATE.HKL 1> <INTEGRATE.HKL 2> > out_file"
